...
const head_data = [
  ...
  },
  {
    ...
    name: "some long long long longer more longer name",
    domain: "EVM 5",
    role: "domain head",
    message:
      ...
      <div className="flex gap-4">
        ...
        <article className="flex flex-col w-full justify-between">
          <div className="flex justify-between ">
            ...
            <h2 className="text-xs text-primary border-[0.05rem] border-primary rounded-2xl py-0.5 px-2 h-fit ">
              {props.role}
            </h2>
          </div>
