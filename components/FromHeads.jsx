...
const Heads = (props) => {
	...
	return (
		<article className="transition-colors break-inside-avoid border-gray-700 border-[1px] rounded-md p-6 hover:bg-white/10">
			<div className="flex gap-4">
				...
				<article className="flex flex-col w-full -gap-y-1 justify-between">
					...
					<div className="flex justify-between items-center my-0.5">
						...
						<p className="text-[12px] text-primary border-[1px] border-primary rounded-2xl py-0 px-2 h-fit">
							{props.role}
						</p>
					</div>
				</article>
