...
export default function FromHeads() {
  return (
    <div className='p-10'>
        <p className='text-2xl mx-auto text-center font-semibold font-montserrat my-4 md:text-start text-white text-transparent'>From Our<span className='text-2xl mx-auto text-center md:text-start font-semibold font-montserrat my-4 text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary'> Heads</span></p>
        ...
        <article className='border border-gray-500 rounded-2xl p-6 hover:border-blue-700'>
            <div className='flex gap-2 bg bg-background font-montserrat'>
                ...
                <article className='hidden md:flex flex-col'>
                    <p className='text-md font-bold md:text-lg'>{props.name}</p>
                    <p className='text-sm font-extralight text-text-secondary'>{props.domain}</p>
                </article>
            </div>
